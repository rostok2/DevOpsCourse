...
чому обрано маску /28?

    кожна підмережа повинна вмістити від 5 до 11 пристроїв хостів, в мережах IPv4 ми завжди рахуємо блоками що є степенями двійки (2, 4, 8, 16)
    В будь-якій підмережі 2 адреси завжди зарезервовані, перша (адреса мережі) та остання (broadcast)
    Нам потрібно мінімум 11 хостів + 2 резервні = 13 адрес
    Найближча степінь двійки, яка більша за 13 — це 16
    Блок із 16 адрес відповідає префіксу 28, оскільки 32 − 4 = 28, де 2^4 = 16

    Маска /28 дає 14 корисних адрес, що ідеально підходить для 5-11 хостів

звідки взялося число 10.0.0.96

    ваші колеги зайняли - 10.0.1.0/24 та 10.0.0.32/26

    10.0.1.0/24 - зайняте все де 3 число 1
    10.0.0.32/26 - маска означає блок з 64 адрес коли гочали з 32, це означає що колеги зайняли все з 32 до 95

чому після 96 іде 112 далі 123...

    оскільки кожна наша підмережа має розмір 16 адрес ми просто додаємо 16 до кожної наступної мережі
